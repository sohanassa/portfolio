...
const translations = {
    el: {
        ...
        "Hello, I'm Sohaib Nassar": 'Γειά, είμαι ο Σουχαήπ Νασσάρ', 'Download Resume': 'Λήψη Βιογραφικού', 'About Me': 'Σχετικά με εμένα', 'Recent Projects': 'Πρόσφατα έργα', 'Get In Touch': 'Επικοινωνήστε μαζί μου',
