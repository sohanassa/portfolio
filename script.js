...
const translations = {
    el: {
        ...
        "Hello, I'm Sohaib Nassar": 'Γεια, είμαι ο Sohaib Nassar', 'Download Resume': 'Λήψη Βιογραφικού', 'About Me': 'Σχετικά με εμένα', 'Recent Projects': 'Πρόσφατα έργα', 'Get In Touch': 'Επικοινωνήστε μαζί μου',
    ...
    ar: {
        ...
        "Hello, I'm Sohaib Nassar": 'مرحباً، أنا Sohaib Nassar', 'Download Resume': 'تحميل السيرة الذاتية', 'About Me': 'نبذة عني', 'Recent Projects': 'أحدث المشاريع', 'Get In Touch': 'تواصل معي',
